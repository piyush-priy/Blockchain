...
let AuthController = (() => {
    ...
    var AuthController = class {
        ...
        static {
            ...
            _updateWallet_decorators = [(0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard), (0, common_1.Put)('wallet'), (0, common_1.HttpCode)(common_1.HttpStatus.OK)];
            ...
            __esDecorate(this, null, _updateWallet_decorators, { kind: "method", name: "updateWallet", static: false, private: false, access: { has: obj => "updateWallet" in obj, get: obj => obj.updateWallet }, metadata: _metadata }, null, _instanceExtraInitializers);
        ...
        async updateWallet(req, updateWalletDto) {
